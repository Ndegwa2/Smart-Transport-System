...
const routesData = [
  { route: "Nairobi to Kisumu", time: "6:00 AM", availableBuses: 5 },
  { route: "Mombasa to Nairobi", time: "7:00 AM", availableBuses: 3 },
  { route: "Nakuru to Eldoret", time: "8:00 AM", availableBuses: 2 }
];
...
function displayAnalytics() {
  if (isAdmin()) {
    ...
    seatAnalyticsSection.innerHTML = `
      ...
      <p>Total Occupied Seats: ${totalAvailableSeats}</p>`;
  } else {
